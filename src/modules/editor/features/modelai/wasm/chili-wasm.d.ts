...
export interface ConnectivityResult extends ClassHandle {
  type: number;
  contactMesh: FaceMeshData;
}

export interface MeshConnectivityChecker extends ClassHandle {}
...
export interface ShapeNode extends ClassHandle {
  ...
  getFaceColors(): Array<string>;
}

export interface VertexColorMesh extends ClassHandle {
  max: number;
  min: number;
  avg: number;
  getVertexCount(): number;
  getVertexColors(): Array<number>;
...
export interface PinPointGate extends ClassHandle {}

export interface ShapeBuilderModelAi extends ClassHandle {}
...
interface EmbindModule {
  ConnectivityResult: {};
  MeshConnectivityChecker: {
    detect(
      _0: Array<FaceMeshData>,
      _1: Array<gp_Trsf>,
      _2: number
    ): ConnectivityResult;
  };
  ...
  Converter: {
    ...
    convertFromThicknessAnalysisResultFrontEndTxt(
      _0: Uint8Array
    ): VertexColorMesh | undefined;
    convertFromSlopeAnalysisResultFrontEndTxt(
      _0: Uint8Array
    ): VertexColorMesh | undefined;
    convertToStep(_0: Array<TopoDS_Shape>): string;
    convertToIges(_0: Array<TopoDS_Shape>): string;
    convertFromRawFacetedEdgeDataFrontEndTxt(
      _0: Uint8Array
    ): EdgeMeshData | undefined;
    convertFromRawFacedTriangleDataFrontEndTxt(
      _0: Uint8Array
  ...
  ShapeBuilderModelAi: {
    ...
    OPipeShell(_0: number, _1: number, _2: TopoDS_Wire): TopoDS_Shape;
    UPipeShell(
      _0: number,
      _1: number,
      _2: number,
